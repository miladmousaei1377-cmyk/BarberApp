...
class MockData {
  ...
  static void _initSalons() {
    salons = [
      ...
      const SalonModel(
        id: 's2',
        name: 'آرایشگاه زیبایی لاله',
        description:
            'آرایشگاه تخصصی خدمات زیبایی بانوان با محیطی آرام و دلنشین. کوتاهی مو، رنگ، کراتین و انواع مدل‌های مدرن توسط متخصصین مجرب',
      ...
      const SalonModel(
        ...
        name: 'آرایشگاه آریا',
        description:
            'آرایشگاه یونیسکس با امکانات مدرن و تیمی از متخصصین با تجربه. مناسب برای خانم‌ها و آقایان. خدمات متنوع با کیفیت بالا',
  ...
  static void _initReviews() {
    reviews = [
      ...
      ReviewModel(
        ...
        salonId: 's2',
        rating: 4,
        comment: 'آرایشگاه تمیز و محیط آرامش‌بخش. رنگم خوب دراومد.',
